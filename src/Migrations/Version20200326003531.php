 ...
 */
final class Version20200326003531 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, ask_id_id INT NOT NULL, user_id_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_DADD4A2542C1DC4D (ask_id_id), INDEX IDX_DADD4A259D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ask (id INT AUTO_INCREMENT NOT NULL, city_id_id INT NOT NULL, mission_id_id INT NOT NULL, user_id_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, objectif VARCHAR(255) NOT NULL, INDEX IDX_6826EAE03CCE3900 (city_id_id), INDEX IDX_6826EAE0EFD2C16A (mission_id_id), INDEX IDX_6826EAE09D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
