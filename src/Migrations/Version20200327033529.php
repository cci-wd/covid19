 ...
 */
final class Version20200327033529 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ask ADD slug VARCHAR(255) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6826EAE02B36786B ON ask (title)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6826EAE02B36786B ON ask');
        $this->addSql('ALTER TABLE ask DROP slug');
